...
ip_json=$(ssh ${user_name}@nimbus-gateway bash -c "'USER=svc.buildpacks nimbus-ctl --outputFormat=json ip svc.buildpacks-buildpacks-private-concourse-worker-$date_time | grep json_info'")
...
echo "Accessing private concourse credhub"
