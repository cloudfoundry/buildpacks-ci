...
#download hub CLI
RUN wget -O- https://github.com/github/hub/releases/download/v2.2.9/hub-linux-amd64-2.2.9.tar.gz | tar xz -C /usr/bin --strip-components=1 hub-linux-amd64-2.2.1/hub
