...
name = 'Monday-Funday *cflinuxfs3* release'
description = 'This is a reminder that a cflinuxfs3 release was automatically started, please monitor it, and deliver story when done.'
