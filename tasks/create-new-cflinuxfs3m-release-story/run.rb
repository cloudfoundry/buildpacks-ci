...
name = 'Monday-Funday *cflinuxfs3m* release'
description = 'This is a reminder that a cflinuxfs3m release was automatically started, please monitor it, and deliver story when done.'
