    ...
    def build_r(source_input, forecast_input, plumber_input, rserve_input, shiny_input)
      ...
      Dir.mktmpdir do |dir|
        Dir.chdir(dir) do
          ...
          Runner.run('apt-get', 'install', '-y', 'gfortran', 'libbz2-dev', 'liblzma-dev', 'libpcre++-dev', 'libpcre2-dev', 'libcurl4-openssl-dev', 'libsodium-dev', 'default-jre', *fs_specific_packages)
