...
module Depwatcher
  class CaApmAgent < Base
    ...
    def in(ref : String) : Release
      url = "https://packages.broadcom.com/artifactory/apm-agents/CA-APM-PHPAgent-#{ref}_linux.tar.gz"
