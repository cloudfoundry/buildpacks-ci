...
Spec2.describe Depwatcher::Rubygems do
  ...
  before do
    client.stub_get("https://rubygems.org/api/v1/versions/abn_search.json", File.read(__DIR__+"/../fixtures/abn_search.json"))
    client.stub_get("https://rubygems.org/api/v2/rubygems/abn_search/versions/0.0.5.json", File.read(__DIR__+"/../fixtures/abn_search_0.0.5.json"))
  end
