...
Spec2.describe Depwatcher::Nginx do
  ...
  before do
    client.stub_get("https://api.github.com/repos/nginx/nginx/tags", HTTP::Client::Response.new(200, File.read(__DIR__+"/../fixtures/github_nginx.json")))
    client.stub_get("http://nginx.org/en/download.html", HTTP::Client::Response.new(200, File.read(__DIR__+"/../fixtures/nginx.html")))
  end
