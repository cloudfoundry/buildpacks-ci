...
Spec2.describe Depwatcher::AppDynamicsAgent do
  ...
  before do
    client.stub_get("https://download.appdynamics.com/download/downloadfile/?apm=php&format=json", HTTP::Client::Response.new(200, File.read(__DIR__+"/../fixtures/appd_agent.json")))
  end
