...
Spec2.describe Depwatcher::Miniconda do
  ...
  describe "#check" do
    it "returns real linux releases for miniconda2 sorted" do
      expect(subject.check("2").map(&.ref)).to eq [
        "4.5.4", "4.5.1", "4.4.10", "4.3.31", "4.3.30", "4.3.27.1", "4.3.27", "4.3.21", "4.3.14", "4.3.11",
        "4.2.12", "4.2.11", "4.1.11", "4.0.5", "3.19.0", "3.18.9", "3.18.3"
      ]
    end
    it "returns real linux releases for miniconda3 sorted" do
      expect(subject.check("3").map(&.ref)).to eq [
        "4.5.4", "4.5.1", "4.4.10", "4.3.31", "4.3.30", "4.3.27.1", "4.3.27", "4.3.21", "4.3.14", "4.3.11",
        "4.2.12", "4.2.11", "4.1.11", "4.0.5", "3.19.0", "3.18.9", "3.18.3",
        "3.16.0", "3.10.1", "3.9.1", "3.8.3", "3.7.3", "3.7.0", "3.6.0", "3.5.5", "3.5.2",
        "3.4.2", "3.3.0", "3.0.5", "3.0.4", "3.0.0", "2.2.2"
      ]
    end
  ...
  describe "#in" do
    it "returns the release version, url, md5 for miniconda2" do
      ...
      expect(obj.url).to eq "https://repo.continuum.io/miniconda/Miniconda2-4.5.4-Linux_x86_64.sh"
    ...
    it "returns the release version, url, md5 for miniconda3" do
     ...
     expect(obj.ref).to eq "4.5.4"
     expect(obj.url).to eq "https://repo.continuum.io/miniconda/Miniconda3-4.5.4-Linux_x86_64.sh"
