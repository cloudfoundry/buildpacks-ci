...
describe 'commit-shas' do
  before :context do
    ...
    execute("-c tasks/commit-shas.yml -i buildpacks-ci=. -i buildpack-checksums=./spec/commit-shas -i buildpack=./spec/commit-shas -i finalize-buildpack=./spec/commit-shas")
  end
